...
class cleaner(object):
    ...
    def meta_prep(cls, target, transformer='gray', verbose=0):
        ...
        if((cat_columns == 0) and (total_null == 0)): 
            ...
            case = 'metamodels/metamodel_case2.pickle'
            if(verbose > 0):
            ...
            case = 'metamodels/metamodel_case3.pickle'
            if(verbose > 0):
            ...
            case = 'metamodels/metamodel_case4.pickle'
            if(verbose > 0):
                print('Case 4: Dataset with categorical data and null values.')

        else:
            case = 'metamodels/metamodel_case5.pickle'
            if(verbose > 0):
